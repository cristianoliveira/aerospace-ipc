...
//
//	mockgen -source=socket.go -destination=internal/mocks/socket.go
//
...
import (
	...
	aerospace_ipc "github.com/cristianoliveira/aerospace-ipc"
...
func (m *MockAeroSpaceSocketConn) SendCommand(command string, args []string) (*aerospace_ipc.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendCommand", command, args)
	ret0, _ := ret[0].(*aerospace_ipc.Response)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
